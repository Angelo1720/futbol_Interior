            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link" href="#" role="button">
                        <img src="/Images/copa-de-futbol.png" alt="Icono"> Campeonatos
                    </a>
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link" href="#" role="button">
                        <img src="/Images/club-de-futbol.png" alt="Icono"> Clubes
                    </a>
                    <ul class="dropdown-menu">
                ...
                @auth
                    @role('admin_Liga')
                        <li class="nav-item dropdown">
                            <a class="nav-link" href="#" role="button">
                                <img src="/Images/administracion.png" alt="Icono"> Administrar
                            </a>
                            <ul class="dropdown-menu">
